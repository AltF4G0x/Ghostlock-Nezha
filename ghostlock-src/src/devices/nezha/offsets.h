/* Xiaomi 17 Ultra (nezha) — SM8850 / Snapdragon 8 Elite Gen 5
 * Global OS3.0.303.0.WPAMIXM (2026-05-13), boot.img f7b6891471
 * kernel_phys_load: 0xc7800000 from verified SM8850 (op15/pudding, same SoC)
 * kallsyms: 125508 symbols via vmlinux-to-elf, _text=0xffffffc080000000
 * extract_target.py verification PASSED (0 errors)
 * extract_btf.py: 57/60, all fields match STRUCT_OFFSETS_6_12 defaults
 * Frames: futex_wait_requeue_pi=0x1c0, core_sys_select=0x1b0 — identical to
 * pudding 6.12.23 build (SP diff=-64, SHIFT=0 expected, unverified on device) */
OFFSETS_ENTRY("6.12.23-android16-5-g5a0e85dd9db0-ab14499855-4k",  /* OS3.0.303.0.WPAMIXM */
